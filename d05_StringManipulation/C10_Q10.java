...
public class C10_Q10 {
	...
	public static void main(String[] args) {
		/*
		 * Kullanýcýdan aldýðýnýz Adý, Soyadý ve kredi kartý numaralarýný aþaðýdaki gibi
		 * özel forma dönüþtürün Kredi kartý numarasýný kontrol edin, yoksa 16 haneden
		 * küçük olursa "Geçersiz kredi kartý numarasý" yazdýrýn. input : John White
		 * 1234234534561478 output: Ad : J*** Soyad :W**** kartNo:***********1478 (Adýn
		 * baþ harfleri ve soyadý büyük olmalýdýr)
		 */
