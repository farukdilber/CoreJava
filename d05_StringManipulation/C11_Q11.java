...
public class C11_Q11 {
	...
	public static void main(String[] args) {
		...
		// 1.yol
		System.out.println("istenilen str= " + pickName.charAt(0) + " " + pickName.substring(11, 12) + " "
		...
		/*
		 * 2.yol char A=pickName.charAt(pickName.indexOf("A"));//A char
		 * L=pickName.charAt(pickName.indexOf("L"));//L char
		 * i=pickName.toLowerCase().charAt(pickName.indexOf("I"));//i
