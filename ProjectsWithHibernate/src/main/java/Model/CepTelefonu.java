...
public class CepTelefonu {
    ...
    public CepTelefonu( double fiyat, int indirimOrani, String urunAdi, String marka, String hafizaBilgisi, String ekranBoyutu, String pilGucu, String ram, String renk) {
